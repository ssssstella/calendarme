...
const platforms: VideoCallProvider[] = ['Zoom Meeting', 'Google Meet', 'Microsoft Teams'];
...
export default function EditEventTypeForm({id, title, url, description, duration, videoCallProvider}: EditEventTypeFormProps) {
  const [activePlatform, setActivePlatform] =
      useState<VideoCallProvider>(videoCallProvider);
      ...
      <Card>
        ...
        <form id={form.id} onSubmit={form.onSubmit} action={action} noValidate>
              ...
              <ButtonGroup>
                {platforms.map((platform) => (
                  <Button
                    ...
                    className="w-full"
                    variant={
                      activePlatform === platform ? 'secondary' : 'outline'
                    }
                  >
                    {platform}
                  </Button>
          ...
          <CardFooter className="w-full flex justify-between">
            ...
            <SubmitButton btnDescription="Edit Event Type" />
          </CardFooter>
        </form>
      </Card>
    </div>
